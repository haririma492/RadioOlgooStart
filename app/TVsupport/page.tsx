            ...
            <div className="grid grid-cols-1 gap-6 xl:grid-cols-[420px_minmax(0,1fr)]">
              <div className="space-y-6">
                <div className="rounded-[24px] border border-white/10 bg-[#071736] p-5 shadow-2xl">
                  <div className="mb-4 flex items-center justify-between gap-3">
                    ...
                    <div className="text-sm text-white/70">
                      {draftPlaylistItems.length} items • {fmtDuration(playlistTotalSeconds)}
                    </div>
                  </div>
                      ...
                      {draftPlaylistItems.map((item, index) => (
                        ...
                        >
                          ...
                          <div className="mt-1 text-sm text-white/60">
                            {fmtDuration(item.durationSec)} • {item.mediaType || "video"}
                          </div>
                ...
                <div className="rounded-[24px] border border-white/10 bg-[#071736] p-5 shadow-2xl">
                  ...
                  {loadingPlaylists ? (
                    <div className="text-base text-white/70">Loading playlists…</div>
                  ) : (
                    <div className="space-y-3">
                      {playlists.length === 0 ? (
                        ...
                        playlists.map((playlist) => (
                          ...
                          >
                            ...
                            <div className="mt-2 text-sm text-white/70">
                              {playlist.itemCount} items • {fmtDuration(playlist.totalDurationSec)}
                            </div>
              ...
              <div className="rounded-[24px] border border-white/10 bg-[#071736] p-5 shadow-2xl">
                ...
                {loadingContent ? (
                  <div className="text-base text-white/70">Loading content library…</div>
                ) : (
                              ...
                              <div className="flex min-w-0 flex-col justify-between p-4">
                                <div>
                                  ...
                                  <div className="mt-2 text-sm text-white/65">
                                    {item.section || "—"} • {item.group || "—"} • {item.person || "—"}
                                  </div>
                                  <div className="mt-1 text-sm text-white/50">
                                    {fmtDuration(Number(item.durationSec || 0))} • {item.mediaType || "video"}
                                  </div>
                                </div>
        ...
        {activeTab === "schedule" && (
          <section className="space-y-6">
            ...
            <div className="rounded-[24px] border border-white/10 bg-[#071736] p-5 shadow-2xl">
              ...
              {loadingSchedules ? (
                <div className="text-base text-white/70">Loading schedules…</div>
              ) : (
                <div className="space-y-3">
                  {schedules.length === 0 ? (
              ...
              <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_420px]">
                <div className="rounded-[24px] border border-white/10 bg-[#071736] p-5 shadow-2xl">
                  ...
                  {loadingPlaybackState ? (
                    <div className="text-base text-white/70">Loading playback state…</div>
                  ) : !playbackState ? (
                    ...
                    <div className="space-y-3 text-base">
                      ...
                      <div>
                        ...
                        <span className="text-white/80">{playbackState.title || "—"}</span>
                      </div>
                      <div className="break-all">
                        <span className="font-semibold">Media URL:</span>{" "}
                        <span className="text-white/80">{playbackState.mediaUrl || "—"}</span>
                      </div>
                      <div>
                        <span className="font-semibold">Source schedule:</span>{" "}
                        <span className="text-white/80">{playbackState.sourceScheduleId || "—"}</span>
                      </div>
                      <div>
                        <span className="font-semibold">Source playlist:</span>{" "}
                        <span className="text-white/80">{playbackState.sourcePlaylistId || "—"}</span>
                      </div>
                      <div>
                        <span className="font-semibold">Started at:</span>{" "}
                        <span className="text-white/80">{playbackState.startedAt || "—"}</span>
                      </div>
                      <div>
                        <span className="font-semibold">Updated at:</span>{" "}
                        <span className="text-white/80">{playbackState.updatedAt || "—"}</span>
                      </div>
                    </div>
                  )}
                </div>
