...
// Sections are fully dynamic â€” any non-empty string is valid.
 ...
 * Generic path â€” not tied to section. Items can move between sections freely.
 */
export async function GET(req: Request) {
  ...
  // Generic S3 key â€” not tied to section
